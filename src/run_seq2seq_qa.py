...
from model_prune import model_prune
...
def main():
    ...
    if model_args.prune_ratio > 0:
        model_prune(model, model_args.prune_ratio)
    ...
    def preprocess_function(examples):
        ...
        labels = tokenizer(text=targets, max_length=max_answer_length, padding=padding, truncation=True)
    ...
    def preprocess_validation_function(examples):
        ...
        for i in range(len(model_inputs["input_ids"])):
            ...
            #model_inputs["id"].append(examples["id"][sample_index])
